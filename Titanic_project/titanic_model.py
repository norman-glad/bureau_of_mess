...
df = pd.read_csv(
    "/home/yiangosa/Documents/GitHub/bureau_of_mess/Titanic_project/titanic3.csv"
)
...
cat_pipeline = Pipeline(
    steps=[
        ("mode_cat", SimpleImputer(strategy="most_frequent")),
        ("one_hot_encode", OneHotEncoder()),
    ]
)
col_transform = ColumnTransformer(
    transformers=[
        ("cat", cat_pipeline, [1, 2]),
...
score = np.mean(
    cross_val_score(
        lr, x_train_scaled, y_train, scoring="accuracy", cv=crossvalidation, n_jobs=1
    )
)
...
clf = RandomizedSearchCV(
    lr, pram_grid, random_state=42, n_iter=100, cv=3, verbose=0, n_jobs=-1
)
...
joblib.dump(
    best_model, "/home/yiangosa/Documents/GitHub/bureau_of_mess/Titanic_project/my_model_titanic.pkl"
)
print("Model dumped!")
joblib.dump(
    col_transform, "/home/yiangosa/Documents/GitHub/bureau_of_mess/Titanic_project/my_pipe_titanic.pkl"
)
print("Pipe dumped!")
joblib.dump(
    scalar, "/home/yiangosa/Documents/GitHub/bureau_of_mess/Titanic_project/my_scalar_titanic.pkl"
)
print("Scalar dumped!")
